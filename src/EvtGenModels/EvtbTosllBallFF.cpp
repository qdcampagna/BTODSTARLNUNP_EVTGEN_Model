...
static EvtId IdKp, IdKm, IdKS, IdK0, IdaK0, IdKL, IdPip, IdPim, IdPi0, IdEta, IdEtap;
                                   ...
                                   double& ft )
{
    if(sfirst){
      ...
      IdKS = EvtPDL::getId("K_S0"); IdK0 = EvtPDL::getId("K0"); IdaK0 = EvtPDL::getId("anti-K0");
      IdKL = EvtPDL::getId("K_L0"); IdPip = EvtPDL::getId("pi+"); IdPim = EvtPDL::getId("pi-");
      IdPi0 = EvtPDL::getId("pi0"); IdEta = EvtPDL::getId( "eta" ); IdEtap = EvtPDL::getId("eta'");
    }
    ...
    if ( daught == IdKp || daught == IdKm || daught == IdKS ||
         daught == IdK0 || daught == IdaK0 || daught == IdKL ) {
        // B --> K form factors
        if ( model == 1 ) {
...
static EvtId IdBs, IdaBs, IdRhop, IdRhom, IdRho0, IdOmega, IdKst0, IdaKst0, IdKstp, IdKstm, IdPhi, IdK1p, IdK1m;
                                   ...
                                   double& t2, double& t3 )
{
    if(vfirst){
      ...
      IdKstp = EvtPDL::getId("K*+"); IdKstm = EvtPDL::getId("K*-"); IdPhi = EvtPDL::getId("phi");
      IdK1p = EvtPDL::getId("K_1+"); IdK1m = EvtPDL::getId("K_1-");
    }
    int model = _theFFModel;
