...
namespace EvtGenFunctions {
    ...
    EvtVector4R asymProd(const EvtVector4R& a, const EvtVector4R& b, const EvtVector4R& c);
    EvtVector4C asymProd(const EvtVector4C& a, const EvtVector4R& b, const EvtVector4R& c);
}    // namespace EvtGenFunctions
