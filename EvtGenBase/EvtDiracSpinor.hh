...
class EvtDiracSpinor final {
    ...
    friend EvtTensor4C EvtLeptonTCurrent( const EvtDiracSpinor& d,
                                          const EvtDiracSpinor& dp );
    friend EvtTensor4C EvtLeptonTACurrent( const EvtDiracSpinor& d,
					   const EvtDiracSpinor& dp );
...
void EvtLeptonVandACurrents(EvtVector4C&, EvtVector4C&, const EvtDiracSpinor&, const EvtDiracSpinor&);
